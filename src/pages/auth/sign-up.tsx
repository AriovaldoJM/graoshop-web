...
export function SignUp(){
    ...
    const  {mutateAsync: registerRestautrantFn} = useMutation({
        ...
        <>
            ...
            <form onSubmit={handleSubmit(handleSignUp)} className='space-y-4'>
                ...
                <p className="px-6 text-center text-sm leading-relaxed text-muted-foreground">
                    Ao continuar, você concorda com a nossos <a className="underline underline-offset-4" href="">Termos de Serviços </a>e<a className="underline underline-offset-4" href="">  Polítcas de Privacidade.</a>
                </p>
            </form>
        </>
    )
